...
import mnist_loader
import network_crossentropy #importamos ahora nuestra red con el crossentrpy
import pickle
...
net = network_crossentropy.Network([784, 30, 10]) #aqui tambien
net.SGD(training_data, 30, 10, 0.5, test_data=test_data)
#guardamos nuestra red
with open("red_pruebaEntropy.pkl", "wb") as f:
    pickle.dump(net, f)
#damos el mensaje que despues de todas las epocas la red ha sido entrenada
print("Entrenamiento terminado y red guardada en red_pruebaEntropy.pkl")
